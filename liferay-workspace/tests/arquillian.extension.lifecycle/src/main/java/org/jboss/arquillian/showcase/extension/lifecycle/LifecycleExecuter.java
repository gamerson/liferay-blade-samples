 ...
 */
package org.jboss.arquillian.showcase.extension.lifecycle;
...
public class LifecycleExecuter
{
   ...
   public void executeBeforeDeploy(@Observes BeforeDeploy event, TestClass testClass)
   {
      execute(
            testClass.getMethods(
                  org.jboss.arquillian.showcase.extension.lifecycle.api.BeforeDeploy.class));
   }
   ...
   public void executeAfterDeploy(@Observes AfterDeploy event, TestClass testClass)
   {
      execute(
            testClass.getMethods(
                  org.jboss.arquillian.showcase.extension.lifecycle.api.AfterDeploy.class));
   }
   ...
   public void executeBeforeUnDeploy(@Observes BeforeUnDeploy event, TestClass testClass)
   {
      execute(
            testClass.getMethods(
                  org.jboss.arquillian.showcase.extension.lifecycle.api.BeforeUnDeploy.class));
   }
   ...
   public void executeAfterUnDeploy(@Observes AfterUnDeploy event, TestClass testClass)
   {
      execute(
            testClass.getMethods(
                  org.jboss.arquillian.showcase.extension.lifecycle.api.AfterUnDeploy.class));
   }
