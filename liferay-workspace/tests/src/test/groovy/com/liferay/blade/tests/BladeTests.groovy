...
class BladeTests extends Specification {
	...
	def setup () {
		...
		def bladeVersion = '1.0.1.201606142156'
		def bladeclijar = "com.liferay.blade.cli_${bladeVersion}.jar"
		def url = "http://releases.liferay.com/tools/blade-cli/${bladeVersion}/plugins/${bladeclijar}"
